...
export function getIndention(text) {
    let indention = 0;
...
export function ensureIndention(text, spaces) {
...
export function unIndentTextWithSpaces(text, spaces) {
...
export function safeExecute(fn, defaultValue) {
    try {
        return fn();
    }
    catch (e) {
 ...
 *  <!-- {{key}} Begin -->
    ...
    <!-- {{key}} End -->
 */
export function replaceHtmlTemplate(template, replacements) {
